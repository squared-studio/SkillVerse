...
1.  **Fork the Repository**
    ...
    *Illustration of Fork Button on GitHub:*
    ```
    Fork Button: (GitHub → "Fork" button at the top-right of the repository page)
    ```
    *(Unfortunately, I cannot directly display images. Imagine a button labeled "Fork" on the top right of a GitHub repository page.)*
...
6.  **Push to Your Fork**
    Push your topic branch to *your forked repository* (`origin`).
    ```bash
...
7.  **Create an Upstream Pull Request**
    ...
    *   **"Compare across forks"**: Ensure your pull request is directed from your fork and topic branch to the *original repository's* `main` (or designated) branch.
...
8.  **Keep Your Fork Fresh and Synchronized**
    ...
    *   **Important:** **Never force-push to shared branches** in team collaboration workflows. Force-pushing is generally safe to *your own fork*.
...
| **Broken CI Pipeline**         | Run tests and linters locally *before* pushing to catch issues early. |
